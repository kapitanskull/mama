	...
	<!-- END PAGE LEVEL PLUGINS -->
						...
						<span class="help-block"> <font style="color:red;">*</font> <i>marked as mandatory</i> </span>
							<?php $error = $this->session->flashdata('error_edit');
								  $berjaya = $this->session->flashdata('success_edit');
								if(isset($error)){
							?>
							...
							<div class="col-md-12">
								<div class="portlet box purple-wisteria">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" class="form-horizontal" method="post" enctype="multipart/form-data" accept-charset="utf-8">
											<div class="form-body">
												<div class="row">
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="row">
															<div class="col-md-offset-3 col-md-9">
																<button type="submit" class="btn green-soft"><i class="fa fa-check"></i> Update</button>
